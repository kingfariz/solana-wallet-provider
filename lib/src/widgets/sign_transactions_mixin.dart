...
import '../solana_wallet_adapter/solana_wallet_adapter.dart'
    show SignTransactionsResult, SolanaWalletAdapter;
...
mixin SignTransactionsState<R, S extends SignTransactionsWidget<R>>
    on AdapterState<R, S> {
  /// Serializes [SignTransactionsWidget.transactions] with [adapter].
  Future<List<String>> _encodeTransactions(
      final SolanaWalletAdapter adapter) async {
